...
public class ApiRestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(final MethodArgumentNotValidException ex, final HttpHeaders headers, final HttpStatus status, final WebRequest request) {
        ...
        String message = "Error Count : " +  ex.getBindingResult().getErrorCount();
    ...
    public ResponseEntity<Object> handleAuthenticationException(final AuthenticationException ex, final WebRequest request) {
	    	...
	    	log.error("error", ex);
        //
        final ApiError apiError = new ApiError(HttpStatus.UNAUTHORIZED, ex.getLocalizedMessage(), "un authorized");
        return new ResponseEntity<Object>(apiError, new HttpHeaders(), apiError.getStatus());
    }
